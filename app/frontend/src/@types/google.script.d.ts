declare namespace google {
    ...
    namespace script {
        interface IRun {
            doGet(e: DoGet): void;
            setData(dataArray: any): void;
            buildSelectOptions(bucode: string | number, defaultIndex: number, datalistId: string, defaultListSheetIndex: number, defaultReturnSheetIndex: number, listSheetName: string): void;
            getWordsFromList(listIndex: number, sheetName: string, returnIndex: number, bucode: string | number): void;
            getMachineDataArray(mgrn: string, mgrnIndex: number, bucode: string | number, listIndex: number, sheetName: string): void;
            getInspDataArray(mgrn: string, mgrnIndex: number, bucode: string | number, sheetName: string): void;
